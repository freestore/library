...
public class ViewController {
    ...
    private Configuration staticConf;
    ...
    public ViewController(int procId) {
        this.staticConf = new Configuration(procId);
    }

    
    public ViewController(int procId, String configHome) {
        this.staticConf = new Configuration(procId, configHome);
    }
    ...
    public Configuration getStaticConf() {
        return staticConf;
    }
